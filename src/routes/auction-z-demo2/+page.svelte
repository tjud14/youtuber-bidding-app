      ...
      {#each cards as card}
        <div class="h-[500px] card-container">
          <ReactiveExplicitZCard
            ...
            initialScale={1}
            hoverScale={1.1}
            cardStyle="border-radius: 1rem; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0);"
            ...
            <svelte:fragment slot="default" let:isHovering let:getItemStyle>
              ...
              <div class="absolute inset-0 flex flex-col justify-end p-8">
                ...
                <div style:transform={getItemStyle(zValues.title).transform}
                     ...
                     class="mb-2">
                  <h3 class="text-2xl font-bold text-white text-shadow-sharp">{card.name}</h3>
                </div>
                ...
                <div style:transform={getItemStyle(zValues.price).transform}
                     ...
                     class="mb-4">
                  <div class="text-3xl font-bold text-white text-shadow-sharp">${card.price}</div>
                </div>
                ...
                <div style:transform={getItemStyle(zValues.photographer).transform}
                  ...
                  <div class="flex items-center gap-2 text-white/80 text-sm">
                    ...
                    <span class="font-medium">Photographed by {card.photographer}</span>
                  </div>
                </div>
                ...
                <div class="flex gap-3">
                  <div style:transform={getItemStyle(zValues.button).transform}
                       ...
                       class="flex-1">
                    <button class="w-full bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 rounded-lg text-sm font-semibold shadow-xl hover:shadow-blue-500/20 transition-all duration-200">
                      Acquire Now
                    </button>
                  </div>
