<script>
        ...
        <div class="h-[480px] card-container">
          ...
          <div class="card-mask">
            <Enhanced3DCard
              ...
              cardStyle="border-radius: 16px !important; overflow: hidden !important;"
            ...
            >
              <svelte:fragment slot="default" let:isHovering let:getItemStyle>
                ...
                <div class="absolute inset-0 force-rounded"
                     ...
                     style="border-radius: 16px !important; overflow: hidden !important;">
                  <div class="w-full h-full bg-gradient-to-br from-gray-900 to-gray-800 force-rounded" 
                       style="border-radius: 16px !important;"></div>
                </div>
  ...
  <style>
    ...
    /* Card container with hardware acceleration */
    .card-container {
      perspective: 1500px;
    ...
    /* Force rounded corners with mask technique */
    .card-mask {
      position: relative;
      height: 100%;
      width: 100%;
      ...
      /* SVG mask for guaranteed rounded corners */
    ...
    /* Critical fixes for component styles */
