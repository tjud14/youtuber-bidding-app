...
<div class="container mx-auto py-12 px-4 min-h-screen">
      ...
      <div class="h-[480px] card-container">
        ...
        >
          <svelte:fragment slot="default" let:isHovering let:getItemStyle>
            ...
            <!-- Content container -->
            <div class="absolute inset-0 flex flex-col justify-end p-8 rounded-xl"
  ...
  <div class="bg-white/10 backdrop-blur-sm p-6 rounded-xl max-w-3xl mx-auto">
    <h2 class="text-xl font-bold mb-4 text-white">Enhanced 3D Card Features</h2>
    <ul class="space-y-3 text-white/80 text-sm">
      <li class="flex items-start gap-2">
        ...
        <span>Customizable Z-depth parameters for each element with <code class="text-blue-300">hoverZScale</code> amplification</span>
      </li>
      <li class="flex items-start gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
        </svg>
        <span>Staggered animations with customizable <code class="text-blue-300">delay</code>, <code class="text-blue-300">customDuration</code>, and <code class="text-blue-300">customEasing</code> parameters</span>
      </li>
      <li class="flex items-start gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
        </svg>
        <span>XY offset transformations with <code class="text-blue-300">xOffset</code> and <code class="text-blue-300">yOffset</code> for parallax-like effects</span>
      </li>
      <li class="flex items-start gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
        </svg>
        <span>Conditional rendering for hover-specific elements like glow effects</span>
      </li>
    </ul>
  </div>
</div>
